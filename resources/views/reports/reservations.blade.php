...
@section('content')
    ...
    <section class="panel report-panel">
        <div class="panel-header panel-header-wrap">
            ...
            <div class="report-actions no-print"><button type="button" class="button-secondary" onclick="window.print()">Cetak</button><a href="{{ route('reports.reservations.excel', request()->query()) }}" class="button-primary button-link">Unduh Excel</a></div>
        </div>
