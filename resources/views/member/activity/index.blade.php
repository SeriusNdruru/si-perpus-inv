...
<section class="member-panel">
    <div class="member-panel-heading"><div><small>Kunjungan membaca</small><h2>Riwayat datang ke perpustakaan</h2></div></div>
    ...
    @if ($visits->hasPages())<div class="member-pagination">{{ $visits->links() }}</div>@endif
</section>

<section class="member-panel">
    <div class="member-panel-heading"><div><small>Riwayat buku</small><h2>Buku yang pernah dipinjam</h2></div><a href="{{ route('member.history.loans') }}">Lihat per transaksi</a></div>
    <div class="member-table-wrap">
        <table class="member-table">
    ...
    @if ($borrowedBooks->hasPages())<div class="member-pagination">{{ $borrowedBooks->links() }}</div>@endif
</section>
@endsection
