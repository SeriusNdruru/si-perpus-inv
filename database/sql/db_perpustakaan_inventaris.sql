...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Agu 2026 pada 16.14
...
(1, 1, 'BK-TEST-001-001', 'BK-TEST-001-001', NULL, 'good', 'borrowed', '2026-07-31', 'purchase', NULL, NULL, 3, 1, NULL, 2, 4, '2026-07-31 12:21:55', '2026-08-01 05:36:17'),
(2, 1, 'BK-TEST-001-002', 'BK-TEST-001-002', NULL, 'good', 'available', '2026-07-31', 'purchase', NULL, NULL, 3, 1, NULL, 2, 4, '2026-07-31 12:21:55', '2026-07-31 17:35:36'),
(3, 1, 'BK-TEST-001-003', 'BK-TEST-001-003', NULL, 'good', 'available', '2026-07-31', 'purchase', NULL, NULL, 3, 1, NULL, 2, 4, '2026-07-31 12:21:55', '2026-07-31 13:50:32');
...
INSERT INTO `book_details` (`item_id`, `isbn_10`, `isbn_13`, `publisher_id`, `publication_year`, `edition`, `language`, `page_count`, `classification_code`, `call_number`, `cover_path`, `catalog_notes`, `completion_status`, `created_at`, `updated_by`, `updated_at`) VALUES
(1, NULL, '9786021234567', 1, 2026, 'Edisi 1', 'Indonesia', 250, '005.13', '005.13 AND d', NULL, NULL, 'complete', '2026-07-31 12:21:55', 2, '2026-07-31 12:33:55');
...
(1, NULL, 'BOOK', 'Buku', 'both', 'Kategori utama untuk buku perpustakaan.', 'active', '2026-07-31 10:21:00', '2026-07-31 10:21:00'),
...
INSERT INTO `items` (`id`, `item_code`, `item_name`, `item_type`, `tracking_type`, `category_id`, `unit_id`, `description`, `minimum_stock`, `status`, `created_by`, `updated_by`, `created_at`, `updated_at`) VALUES
(1, 'BK-TEST-001', 'Dasar Pemrograman Web', 'book', 'asset', 7, 3, NULL, 1.00, 'active', 2, 2, '2026-07-31 12:21:55', '2026-07-31 12:21:55');
...
(1, 'RK-TI-01', 'Rak Teknologi Informasi', 3, '000-099', 100, 'Rak buku komputer dan teknologi', 'active', 4, '2026-07-31 13:34:06', '2026-07-31 13:34:06');
...
(4, 'PJM-20260801-123617-6VLZ', 2, '2026-08-01 12:36:17', '2026-08-08', 'active', 4, 'Dibuat dari pengajuan REQ-20260801-123548-2XRE', '2026-08-01 05:36:17', '2026-08-01 05:36:17');
...
(5, 4, 1, '2026-08-01 12:36:17', '2026-08-08', 'good', NULL, NULL, 'borrowed', 0.00, NULL, NULL, '2026-08-01 05:36:17', '2026-08-01 05:36:17');
...
(3, 'REQ-20260801-143621-NHPC', 2, 'submitted', '2026-08-01 14:36:21', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2026-08-01 07:36:21', '2026-08-01 07:36:21');
...
(3, 3, 1, NULL, '2026-08-01 07:36:21');
...
(1, NULL, 'GDG-UTAMA', 'Gedung Utama', 'building', NULL, 'active', '2026-07-31 12:01:26', '2026-07-31 12:01:26'),
(2, 1, 'LT-01', 'Lantai 1', 'floor', NULL, 'active', '2026-07-31 12:02:03', '2026-07-31 12:02:03'),
(3, 2, 'R-PERPUS', 'Ruang Perpustakaan', 'room', NULL, 'active', '2026-07-31 12:02:49', '2026-07-31 12:02:49');
...
(1, 'AGT-2026-00001', NULL, 'Andi Pratama', 'student', '20260001', 'Kelas 1', '081234567890', 'andi@example.com', NULL, '2026-07-31', '2027-07-31', 'active', 4, '2026-07-31 16:33:55', '2026-08-01 14:09:52'),
...
(1, 'RUS-20260801-142646-8IIV', 1, 1, 3, 'Rius', '082277625541', 'bukunya sobek bagian halaman 230', 'damage-reports/cSL1TKMEDTLjsoSfKevO8aAQdMBhTRFfwViUye8g.png', 'submitted', 3, NULL, '2026-08-01 07:26:46', '2026-08-01 07:34:50');
...
(1, 'RSV-20260801-005716-SN3U', 1, 1, '2026-08-01 00:57:16', '2026-08-03 00:57:16', 1, 'ready', 4, NULL, '2026-07-31 17:57:16', '2026-07-31 17:57:16');
...
(1, 'SUP-001', 'PT. Sumber Ilmu', 'Budi Santoso', '0812-3456-7890', 'supplier@example.com', 'Kota Makassar', 'active', '2026-07-31 11:51:55', '2026-07-31 11:51:55');
...
(2, 'Admin Full Access', 'Admin1', NULL, NULL, '$2y$12$paOO7a4bYIBIwUuSlVRaBeOZva6/.7Y49y585VlANfnSgpJIQvV7u', NULL, NULL, 'active', '2026-08-01 21:00:27', '2026-07-31 11:17:29', '2026-08-01 14:00:27'),
(3, 'Admin Inventory', 'admin2', NULL, NULL, '$2y$12$LJh7vW1VQCNB7bpwpHsjReoLT79TLShz7YCe40rCblxqOqeAAgOJG', NULL, NULL, 'active', '2026-08-01 14:51:47', '2026-07-31 12:50:19', '2026-08-01 07:51:47'),
(4, 'Admin Library', 'admin3', NULL, NULL, '$2y$12$sVcDUiVyHF0y3TQjMSX8nuhsVdN3J7GxkgVSC8eVeNwCpGn9tIkDO', NULL, NULL, 'active', '2026-08-01 14:36:36', '2026-07-31 12:53:45', '2026-08-01 07:36:36'),
